# -*- coding: utf-8 -*-
"""
Created on Tue Mar 14 21:36:00 2023
...
class GPT(nn.Module):
    ...
    def forward(self, state_embeddings, actions, targets=None, rtgs=None, timesteps=None):
        # states: (batch, block_size, 4*84*84)    8 x 8 x 12 = 768 (8 x 8 board, 2 players x 6 piece types) 
        # actions: (batch, block_size, 1)    8x8x(8*7+8+9) = 
        
        
        # state_embeddings: (batch, block_size, 8*8*12) - 8x8 board, 2 players x 6 piece types
